...
def karakter_segmentasyonu(ikili_inv: np.ndarray, girdi_bgr: np.ndarray) -> np.ndarray:
    ...
    - Amaç: Harf/karakter benzeri bağlı bileşenleri bulmak ve görselleştirmek.
    - Adımlar:
        a) Küçük gürültüyü temizlemek için hafif morfolojik açma/kapama
        b) Bağlı bileşen analizi (connected components)
        c) Makul boyuttaki bileşenleri kutu içine alma
    Çıktı: BGR görüntü üzerinde kutular çizilmiş görsel.
    """
...
def main():
    resim = cv2.imread('../RESIMLER/proje55.jpg', cv2.IMREAD_GRAYSCALE)
